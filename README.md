...
## 🌎 Sensor de Solo
- **data_registro**: Data/hora da medição  
...
## 🧪 Insumo
- **nome**: Nome do insumo (Sementes, Fertilizante, etc.)  
- **tipo**: Tipo de insumo (Semente, Adubo, etc.)  
- **preco_unitario**: Preço unitário (R$)  
- **unidade_medida**: kg, L, saca, etc.  
- **quantidade**: Número  
...
- MongoDB  
- Node.js / Java / Spring Boot (opcional, para integração)  
